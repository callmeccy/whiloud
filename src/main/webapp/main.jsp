...
<jsp:include page="title.jsp"/>
		<div class="move bg1" style="position:absolute; z-index:99999; ">
			<div class="container">
				<div id="activityButton" style="height:75px;text-align:center;line-height:75px;">最新範本</div>
				<div id="videoButton" style="height:75px;text-align:center;line-height:75px;">最新影片</div>
...
<!-- 						<li><img src="images/T5.jpg" alt=""></li> -->
			...
			<div id="page2" class="page">
				...
				<div id="showSign3" class="wow fadeInUpBig" data-wow-duration="2s">最新影片</div>
